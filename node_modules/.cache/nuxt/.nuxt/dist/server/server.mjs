...
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, isRef, customRef, isReadonly, isShallow, isReactive, toRaw, createVNode, Text, Fragment, watch, Suspense, mergeProps, useSSRContext, defineAsyncComponent, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { debounce } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/perfect-debounce/dist/index.mjs";
import { defu, createDefu } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/defu/dist/defu.mjs";
import { hash, isEqual } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/ohash/dist/index.mjs";
import { isPlainObject as isPlainObject$1 } from "@vue/shared";
import { klona } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/klona/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, withoutTrailingSlash, withLeadingSlash, withBase, withTrailingSlash, stringifyQuery, parsePath, parseQuery, isEqual as isEqual$1, withHttps, withoutBase } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1, resolveUnrefHeadInput } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/@unhead/vue/dist/index.mjs";
import { InferSeoMetaPlugin } from "@unhead/addons";
import { TemplateParamsPlugin } from "unhead/plugins";
import { titleCase, camelCase } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/scule/dist/index.mjs";
import { parse as parse$1 } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import { getRequestURL as getRequestURL$1, getRequestHeader as getRequestHeader$1, getCookie as getCookie$1 } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/h3/dist/index.mjs";
import { SchemaOrgUnheadPlugin, defineWebSite, defineWebPage } from "@unhead/schema-org/vue";
import { stringify, parse as parse$2 } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/devalue/index.js";
import { toRouteMatcher, createRouter as createRouter$1 } from "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/radix3/dist/index.mjs";
import { setupDevtoolsPlugin } from "@vue/devtools-api";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const component_45stubKNsr2_fgeqYZ60v93Fq6mjYE46JpSVsL1Ky7qNXvP78 = {};
const _routes = [
  {
    name: "blog-slug___en",
    path: "/blog/:slug()",
    component: () => import("./_nuxt/_slug_-BGp5SHSc.js")
  },
  {
    name: "blog-slug___zh",
    path: "/zh/blog/:slug()",
  ...
  },
  {
    name: "blog___en",
    path: "/blog",
    component: () => import("./_nuxt/index-CCiU7USE.js")
  },
  {
    name: "blog___zh",
    path: "/zh/blog",
  ...
  },
  {
    name: "privacy___en",
    path: "/privacy",
    component: () => import("./_nuxt/privacy-BDbyIdQR.js")
  },
  {
    name: "privacy___zh",
    path: "/zh/privacy",
  ...
  },
  {
    name: "terms___en",
    path: "/terms",
    component: () => import("./_nuxt/terms-MGd9HKg1.js")
  },
  {
    name: "terms___zh",
    path: "/zh/terms",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import("./_nuxt/index-SrRUV8bI.js")
  },
  {
    name: "index___zh",
    path: "/zh",
  ...
  },
  {
    ...
    path: "/sitemap.xml",
    component: component_45stubKNsr2_fgeqYZ60v93Fq6mjYE46JpSVsL1Ky7qNXvP78
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/zh/sitemap.xml",
...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_3f76b251",
      load: () => import(
        "./_nuxt/en-DhPsaOKW.js"
        /* webpackChunkName: "locale_en_46json_3f76b251" */
      ),
      cache: true
    }
  ],
  zh: [
    {
      key: "locale_zh_46json_b4b529ba",
      load: () => import(
        "./_nuxt/zh-DkrbWuBv.js"
        /* webpackChunkName: "locale_zh_46json_b4b529ba" */
      ),
      cache: true
    }
  ],
  "zh-tw": [
    {
      key: "locale_zh_45tw_46json_0cd62b9f",
      load: () => import(
        "./_nuxt/zh-tw-CSydA_RX.js"
        /* webpackChunkName: "locale_zh_45tw_46json_0cd62b9f" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/CxkovPxQ"}/${locale}/messages.json`, { headers });
...
const componentNames = [{ "hash": "SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM", "pascalName": "BrandedLogo", "kebabName": "branded-logo", "path": "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue", "category": "community" }, { "hash": "tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY", "pascalName": "Frame", "kebabName": "frame", "path": "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue", "category": "community" }, { "hash": "NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM", "pascalName": "Nuxt", "kebabName": "nuxt", "path": "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue", "category": "community" }, { "hash": "VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4", "pascalName": "NuxtSeo", "kebabName": "nuxt-seo", "path": "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue", "category": "community" }, { "hash": "8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM", "pascalName": "Pergel", "kebabName": "pergel", "path": "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue", "category": "community" }, { "hash": "b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s", "pascalName": "SimpleBlog", "kebabName": "simple-blog", "path": "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue", "category": "community" }, { "hash": "vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI", "pascalName": "UnJs", "kebabName": "un-js", "path": "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue", "category": "community" }, { "hash": "hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw", "pascalName": "Wave", "kebabName": "wave", "path": "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue", "category": "community" }, { "hash": "zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws", "pascalName": "WithEmoji", "kebabName": "with-emoji", "path": "/Users/shook/Documents/Claude code/项目/Canlah-AI/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue", "category": "community" }];
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/CxkovPxQ"}/${locale}/messages.json`));
...
const scroll_reveal_tPX157eTa7BVKjc00Kd5t0xD0NlSdRryGIUd8cJxtfw = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.directive("reveal", {
    getSSRProps: () => ({}),
    mounted(el, binding) {
      const delay = binding.value?.delay ?? 0;
      const distance = binding.value?.distance ?? 22;
      const threshold = binding.value?.threshold ?? 0.1;
      const captureMode = (void 0).hash.includes("figmacapture=");
      if (captureMode) {
        el.style.opacity = "1";
        el.style.transform = "translateY(0)";
        return;
      }
      const rotate = binding.value?.rotate ?? 6;
      const scale = binding.value?.scale ?? 0.96;
      el.style.opacity = "0";
...
const plugins = [
  ...
  scroll_reveal_tPX157eTa7BVKjc00Kd5t0xD0NlSdRryGIUd8cJxtfw,
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { t } = useI18n();
    const brandLogos = [
      { src: "/brands/Alibaba.png", alt: "Alibaba" },
      { src: "/brands/ByteDance.png", alt: "ByteDance" },
      { src: "/brands/MaCann.png", alt: "McCann" },
      { src: "/brands/Starbucks.png", alt: "Starbucks" }
    ];
    const brandsLoop = [...brandLogos, ...brandLogos, ...brandLogos, ...brandLogos];
    useHead({
      link: [
        { rel: "icon", type: "image/svg+xml", href: "/favicon.svg" },
        { rel: "preconnect", href: "https://fonts.googleapis.com" },
        { rel: "preconnect", href: "https://fonts.gstatic.com", crossorigin: "" },
        { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Bai+Jamjuree:wght@400;500;600;700&family=Inter:wght@400;500;600;700&family=DM+Mono:wght@300;400;500&display=swap" }
      ],
      script: [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#0a090f] text-[#efefe5] font-sans selection:bg-[#815ff7] selection:text-[#efefe5] relative overflow-x-clip crosshair-frame" }, _attrs))}><i aria-hidden="true"></i><i class="edge top" aria-hidden="true"></i><i class="edge bottom" aria-hidden="true"></i><i class="edge left" aria-hidden="true"></i><i class="edge right" aria-hidden="true"></i><div class="fixed inset-0 pointer-events-none z-0" aria-hidden="true"><div class="absolute top-0 bottom-0 left-1/4 w-px bg-[#efefe5]/25"></div><div class="absolute top-0 bottom-0 left-1/2 w-px bg-[#efefe5]/30"></div><div class="absolute top-0 bottom-0 left-3/4 w-px bg-[#efefe5]/25"></div></div><svg class="fixed inset-0 w-full h-full pointer-events-none z-0 opacity-[0.025]" xmlns="http://www.w3.org/2000/svg"><filter id="grain"><feTurbulence type="fractalNoise" baseFrequency="0.65" numOctaves="3" stitchTiles="stitch"></feTurbulence></filter><rect width="100%" height="100%" filter="url(#grain)"></rect></svg><div class="fixed inset-0 pointer-events-none z-0 opacity-50" style="${ssrRenderStyle({ "background-image": "radial-gradient(circle, rgba(189,209,246,0.04) 1px, transparent 1px)", "background-size": "40px 40px" })}"></div><div class="fixed w-[700px] h-[700px] rounded-[2px] blur-[140px] opacity-[0.05] pointer-events-none z-0 bg-[#91B3F0] -top-[200px] -left-[200px]"></div><div class="fixed w-[500px] h-[500px] rounded-[2px] blur-[120px] opacity-[0.04] pointer-events-none z-0 bg-[#BDD1F6] top-[60%] -right-[100px]"></div><div class="fixed bottom-0 left-0 right-0 z-[20] pointer-events-none bg-[#0B0A10]/92 backdrop-blur-md border-t border-[#efefe5]/10 py-3 sm:py-4"><div class="w-full overflow-hidden [mask-image:linear-gradient(90deg,transparent,black_6%,black_94%,transparent)]"><div class="flex items-center gap-12 sm:gap-16 lg:gap-24 anim-logo-loop whitespace-nowrap"><!--[-->`);
      ssrRenderList(brandsLoop, (b, bi) => {
        _push(`<img${ssrRenderAttr("src", b.src)}${ssrRenderAttr("alt", b.alt)} class="h-5 sm:h-6 w-auto opacity-65 flex-shrink-0 select-none" loading="lazy" draggable="false">`);
      });
      _push(`<!--]--></div></div></div><div class="hidden xl:flex flex-col gap-6 fixed right-4 top-1/2 -translate-y-1/2 z-30 items-center pointer-events-none"><span class="vlabel">INTRO</span><div class="flex flex-col gap-1.5"><!--[-->`);
      ssrRenderList(6, (i) => {
        _push(`<span class="w-1 h-1 rounded-[2px] bg-[#efefe5]/30"></span>`);
      });
      _push(`<!--]--></div><span class="vlabel">MENU</span></div><div class="relative z-[1]"><a href="#main-content" class="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[60] focus:px-4 focus:py-2 focus:rounded-[2px] focus:bg-[#91B3F0] focus:text-[#0a090f] focus:text-sm focus:font-bold focus:shadow-lg focus:outline-none"> Skip to main content </a>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#0a090f] text-[#efefe5] flex items-center justify-center px-6 relative overflow-hidden" }, _attrs))}><svg class="fixed inset-0 w-full h-full pointer-events-none z-0 opacity-[0.028]" xmlns="http://www.w3.org/2000/svg"><filter id="grain"><feTurbulence type="fractalNoise" baseFrequency="0.65" numOctaves="3" stitchTiles="stitch"></feTurbulence></filter><rect width="100%" height="100%" filter="url(#grain)"></rect></svg><div class="fixed w-[500px] h-[500px] rounded-[2px] blur-[140px] opacity-[0.06] pointer-events-none bg-[#91B3F0] top-[20%] left-[30%]"></div><div class="relative z-[1] text-center max-w-lg"><div class="font-display font-bold text-[120px] md:text-[160px] leading-none bg-gradient-to-b from-white/20 to-white/5 bg-clip-text text-transparent select-none mb-4">${ssrInterpolate(__props.error.statusCode)}</div><h1 class="font-display font-bold text-2xl md:text-3xl text-[#efefe5] mb-4">${ssrInterpolate(unref(is404) ? "Page not found" : "Something went wrong")}</h1><p class="text-[15px] text-[#BABABA] mb-10 leading-[1.5]">${ssrInterpolate(unref(is404) ? "The page you're looking for doesn't exist or has been moved. Let's get you back on track." : "An unexpected error occurred. Try refreshing or head back to the homepage.")}</p><div class="flex gap-4 justify-center flex-wrap"><button class="group px-8 py-3.5 rounded-[2px] font-bold text-sm bg-gradient-to-r from-[#91B3F0] to-[#BDD1F6] text-[#efefe5] hover:shadow-[0_0_30px_rgba(189,209,246,0.4)] transition-all hover:scale-[1.03] flex items-center gap-2"> Back to homepage <span class="group-hover:translate-x-1 transition-transform">→</span></button><a href="https://app.canmarket.ai" target="_blank" class="px-8 py-3.5 rounded-[2px] font-bold text-sm border border-white/15 text-[#efefe5]/80 hover:border-[#BDD1F6]/50 hover:text-[#efefe5] hover:bg-white/5 transition-all"> Try CanMarket Free </a></div><div class="mt-16 flex items-center justify-center gap-2 opacity-40"><div class="w-6 h-6 rounded-[2px] bg-gradient-to-br from-[#91B3F0] to-[#BDD1F6] flex items-center justify-center text-[10px]">⬡</div><span class="font-display font-bold text-sm tracking-wide">CANLAH AI</span></div></div></div>`);
    };
  }
});
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-CN7KCbwd.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
