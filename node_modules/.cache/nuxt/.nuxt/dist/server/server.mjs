...
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, isRef, customRef, isReadonly, isShallow, isReactive, toRaw, Fragment, createVNode, Text, watch, Suspense, mergeProps, useSSRContext, defineAsyncComponent, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/private/tmp/canlah-website/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/private/tmp/canlah-website/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/private/tmp/canlah-website/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/private/tmp/canlah-website/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { debounce } from "/private/tmp/canlah-website/node_modules/perfect-debounce/dist/index.mjs";
import { defu, createDefu } from "/private/tmp/canlah-website/node_modules/defu/dist/defu.mjs";
import { hash, isEqual } from "/private/tmp/canlah-website/node_modules/ohash/dist/index.mjs";
import { isPlainObject as isPlainObject$1 } from "@vue/shared";
import { klona } from "/private/tmp/canlah-website/node_modules/klona/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, withoutTrailingSlash, withLeadingSlash, withBase, withTrailingSlash, stringifyQuery, parsePath, parseQuery, isEqual as isEqual$1, withHttps, withoutBase } from "/private/tmp/canlah-website/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1, resolveUnrefHeadInput } from "/private/tmp/canlah-website/node_modules/@unhead/vue/dist/index.mjs";
import { InferSeoMetaPlugin } from "@unhead/addons";
import { TemplateParamsPlugin } from "unhead/plugins";
import { titleCase, camelCase } from "/private/tmp/canlah-website/node_modules/scule/dist/index.mjs";
import { parse as parse$1 } from "/private/tmp/canlah-website/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import { getRequestURL as getRequestURL$1, getRequestHeader as getRequestHeader$1, getCookie as getCookie$1 } from "/private/tmp/canlah-website/node_modules/h3/dist/index.mjs";
import { SchemaOrgUnheadPlugin, defineWebSite, defineWebPage } from "@unhead/schema-org/vue";
import { stringify, parse as parse$2 } from "/private/tmp/canlah-website/node_modules/devalue/index.js";
import { toRouteMatcher, createRouter as createRouter$1 } from "/private/tmp/canlah-website/node_modules/radix3/dist/index.mjs";
...
const _routes = [
  {
    name: "privacy___en",
    path: "/privacy",
    component: () => import("./_nuxt/privacy-DALQXDCC.js")
  },
  {
    name: "privacy___zh",
    path: "/zh/privacy",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import("./_nuxt/index-JvFdjdCH.js")
  },
  {
    name: "index___zh",
    path: "/zh",
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-BnF1vElo.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
