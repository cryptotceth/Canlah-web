...
import { hasInjectionContext, inject, computed, getCurrentInstance as getCurrentInstance$1, shallowRef, defineComponent, createElementBlock, provide, cloneVNode, h, ref, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, shallowReactive, mergeProps, unref, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, getCurrentScope, toRef, toValue, isReadonly, isRef, isShallow, isReactive, toRaw, watch, nextTick, customRef } from 'vue';
import { i as createError$1, M as parseURL, T as encodePath, U as decodePath, V as headSymbol, W as defu, X as hasProtocol, Y as isScriptProtocol, n as joinURL, Z as withQuery, _ as useHead$1, $ as sanitizeStatusCode, a0 as getContext, a1 as $fetch$1, a2 as baseURL, L as hash, a3 as executeAsync, a4 as withoutTrailingSlash, a5 as titleCase, a6 as withHttps, a7 as stringifyQuery, a8 as camelCase, a9 as withLeadingSlash, aa as withBase, H as withTrailingSlash, ab as toRouteMatcher, ac as createRouter$1, ad as withoutBase, ae as getRequestURL, af as useSeoMeta$1, ag as getRequestHeader, ah as getCookie, ai as klona, aj as parsePath, ak as parseQuery, al as isEqual, am as createDefu, an as setCookie, ao as deleteCookie, ap as resolveUnrefHeadInput, aq as isEqual$1 } from '../nitro/nitro.mjs';
...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
import 'lru-cache';
import '@unocss/core';
...
const matcher = /* @__PURE__ */ (() => {
  ...
  return (m, p) => {
    ...
    if (p === "/__sitemap__/style.xsl") {
      ...
      r.unshift({ data: $0 });
    } else if (p === "/__sitemap__/zh-TW.xml") {
      r.unshift({ data: $0 });
    } else if (p === "/_nuxt") {
      r.unshift({ data: $0 });
    }
...
const component_45stub8JwX6Qdb7ycM3gaF6f4zN60adO03CuqJNZvetwoo8hk = {};
const _routes = [
  {
    name: "privacy___en",
    path: "/privacy",
    component: () => import('./privacy-DALQXDCC.mjs')
  },
  {
    name: "privacy___zh",
    path: "/zh/privacy",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-JvFdjdCH.mjs')
  },
  {
    name: "index___zh",
    path: "/zh",
  ...
  },
  {
    ...
    path: "/sitemap.xml",
    component: component_45stub8JwX6Qdb7ycM3gaF6f4zN60adO03CuqJNZvetwoo8hk
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/zh/sitemap.xml",
  ...
  en: [
    {
      ...
      load: () => import(
        './en-B38IPktr.mjs'
        /* webpackChunkName: "locale_en_46json_0ca0f0f4" */
      ),
      cache: true
    }
  ],
  zh: [
    {
      ...
      load: () => import(
        './zh-Cz14nTKn.mjs'
        /* webpackChunkName: "locale_zh_46json_f839a992" */
      ),
      cache: true
    }
  ],
  "zh-tw": [
    {
      ...
      load: () => import(
        './zh-tw-YXqDRo77.mjs'
        /* webpackChunkName: "locale_zh_45tw_46json_9c33f892" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/uo_-vXpS"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/uo_-vXpS"}/${locale}/messages.json`));
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useHead({
      ...
      meta: [
        { name: "description", content: "The AI platform company behind CanMarket, CanService, CanSales & CanCommerce. Intelligent agents that automate marketing, sales, service, and commerce." },
        { property: "og:type", content: "website" },
        { property: "og:site_name", content: "CANLAH AI" },
        { property: "og:title", content: "CANLAH AI — AI Agents for Every Business Function" },
        { property: "og:description", content: "Intelligent AI agents that automate marketing, sales, service, and commerce. Style Genome™ brand memory ensures every output looks like your team made it. Trusted by Haleon, Starbucks, Publicis." },
        { property: "og:url", content: "https://canlah.ai" },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: "CANLAH AI — AI Agents for Every Business Function" },
        { name: "twitter:description", content: "AI agents that automate marketing, sales, service & commerce with brand memory. Start free." }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtPage = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#070d16] text-[#e8f0ff] font-sans selection:bg-[#00d4ff] selection:text-black relative overflow-x-hidden" }, _attrs))}><svg class="fixed inset-0 w-full h-full pointer-events-none z-0 opacity-[0.028]" xmlns="http://www.w3.org/2000/svg"><filter id="grain"><feTurbulence type="fractalNoise" baseFrequency="0.65" numOctaves="3" stitchTiles="stitch"></feTurbulence></filter><rect width="100%" height="100%" filter="url(#grain)"></rect></svg><div class="fixed inset-0 pointer-events-none z-0" style="${ssrRenderStyle({ "background-image": "radial-gradient(circle, rgba(100,150,255,0.025) 1px, transparent 1px)", "background-size": "40px 40px", "opacity": "0.5" })}"></div><div class="fixed w-[700px] h-[700px] rounded-full blur-[140px] opacity-[0.05] pointer-events-none z-0 bg-[#0d3ab0] -top-[200px] -left-[200px]"></div><div class="fixed w-[500px] h-[500px] rounded-full blur-[120px] opacity-[0.04] pointer-events-none z-0 bg-[#1090c8] top-[60%] -right-[100px]"></div><div class="fixed w-[400px] h-[400px] rounded-full blur-[120px] opacity-[0.035] pointer-events-none z-0 bg-[#4a6aaf] top-[30%] left-[40%]"></div><div class="relative z-[1]"><a href="#main-content" class="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[60] focus:px-4 focus:py-2 focus:rounded-lg focus:bg-[#0d47e0] focus:text-white focus:text-sm focus:font-semibold focus:shadow-lg focus:outline-none"> Skip to main content </a>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#070d16] text-[#e8f0ff] flex items-center justify-center px-6 relative overflow-hidden" }, _attrs))}><svg class="fixed inset-0 w-full h-full pointer-events-none z-0 opacity-[0.028]" xmlns="http://www.w3.org/2000/svg"><filter id="grain"><feTurbulence type="fractalNoise" baseFrequency="0.65" numOctaves="3" stitchTiles="stitch"></feTurbulence></filter><rect width="100%" height="100%" filter="url(#grain)"></rect></svg><div class="fixed w-[500px] h-[500px] rounded-full blur-[140px] opacity-[0.06] pointer-events-none bg-[#0d3ab0] top-[20%] left-[30%]"></div><div class="relative z-[1] text-center max-w-lg"><div class="font-display font-extrabold text-[120px] md:text-[160px] leading-none bg-gradient-to-b from-white/20 to-white/5 bg-clip-text text-transparent select-none mb-4">${ssrInterpolate(__props.error.statusCode)}</div><h1 class="font-display font-bold text-2xl md:text-3xl text-white mb-4">${ssrInterpolate(unref(is404) ? "Page not found" : "Something went wrong")}</h1><p class="text-[15px] text-[#5a7090] mb-10 leading-relaxed">${ssrInterpolate(unref(is404) ? "The page you're looking for doesn't exist or has been moved. Let's get you back on track." : "An unexpected error occurred. Try refreshing or head back to the homepage.")}</p><div class="flex gap-4 justify-center flex-wrap"><button class="group px-8 py-3.5 rounded-full font-semibold text-sm bg-gradient-to-r from-[#0d47e0] to-[#00d4ff] text-white hover:shadow-[0_0_30px_rgba(0,212,255,0.4)] transition-all hover:scale-[1.03] flex items-center gap-2"> Back to homepage <span class="group-hover:translate-x-1 transition-transform">→</span></button><a href="https://app.canmarket.ai" target="_blank" class="px-8 py-3.5 rounded-full font-semibold text-sm border border-white/15 text-white/80 hover:border-[#00d4ff]/50 hover:text-white hover:bg-white/5 transition-all"> Try CanMarket Free </a></div><div class="mt-16 flex items-center justify-center gap-2 opacity-40"><div class="w-6 h-6 rounded-md bg-gradient-to-br from-[#0d47e0] to-[#00d4ff] flex items-center justify-center text-[10px]">⬡</div><span class="font-display font-bold text-sm tracking-wide">CANLAH AI</span></div></div></div>`);
    };
  }
});
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-BnF1vElo.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { useI18n as a, useRouter as b, createError as c, useNuxtApp as d, entry_default as default, encodeRoutePath as e, useRuntimeConfig as f, nuxtLinkDefaults as g, useOgImageRuntimeConfig as h, injectHead as i, useSiteConfig as j, navigateTo as n, resolveRouteObject as r, useHead as u };
