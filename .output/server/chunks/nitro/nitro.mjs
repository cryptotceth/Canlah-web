...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2026-03-19T18:05:57.704Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2026-03-19T18:05:57.704Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "d4d8a00d-69c2-4330-9c87-1acb4a4c8253",
...
const _Jd2c0TrI6BMIG5Thx_w6dDBPcaFK4gzhvQsIW1TpWg = defineNitroPlugin(async (nitroApp) => {
...
const _WH60A5T9dDuzZ4MmVOPKVoTrvuJDLIzMDQinoQKwKZE = defineNitroPlugin(async (nitroApp) => {
...
const theme = {"fontFamily":{"display":["Syne","sans-serif"],"mono":["DM Mono","monospace"],"sans":["Outfit","sans-serif"]}};
...
const componentNames = [{"hash":"SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/private/tmp/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community"},{"hash":"tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY","pascalName":"Frame","kebabName":"frame","path":"/private/tmp/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community"},{"hash":"NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM","pascalName":"Nuxt","kebabName":"nuxt","path":"/private/tmp/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community"},{"hash":"VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/private/tmp/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community"},{"hash":"8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM","pascalName":"Pergel","kebabName":"pergel","path":"/private/tmp/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community"},{"hash":"b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/private/tmp/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community"},{"hash":"vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI","pascalName":"UnJs","kebabName":"un-js","path":"/private/tmp/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community"},{"hash":"hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw","pascalName":"Wave","kebabName":"wave","path":"/private/tmp/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community"},{"hash":"zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/private/tmp/canlah-website/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community"}];
...
const _GGAffswNZBno80JrEIle4mYWGxo2x5QwjYkH9_toRhg = defineNitroPlugin(async (nitro) => {
  return;
});
...
var hero$2 = {
	badge1: "AI-POWERED",
	badge2: "MULTI-VERTICAL",
	line1: "AI Agents for",
	line3: "at Scale",
	description: "CANLAH AI builds intelligent agents that automate marketing, sales, service, and commerce — so your team focuses on what matters.",
	cta: "Try CanMarket Free",
	cta2: "See Products",
	trustedBy: "TRUSTED BY LEADING BRANDS",
	brand1: "HALEON",
	brand2: "STARBUCKS",
	brand3: "BYTEDANCE",
	brand4: "ALIBABA CLOUD",
	brand5: "PUBLICIS",
	brand6: "McCANN"
};
var stats$2 = {
...
var team$2 = {
	...
	award: "MWC Pitch2Pitch 2025 · Global Runner-up",
	awardSub: "Barcelona · Competing against 3,000+ startups worldwide",
	members: [
		{
			initials: "HP",
			name: "Haoyang Pang",
			role: "CEO & Founder",
			cred: "Stanford AI research. Creator of Style Genome™ — the brand memory layer powering every CANLAH product.",
			tag: "AI Architecture"
		},
		{
			initials: "DC",
			name: "David Chu",
			role: "Co-Founder",
			cred: "20 years in 4A agencies. Led campaigns for Fortune 500 brands across APAC. MWC 2025 Global Runner-up.",
			tag: "Brand Strategy"
		},
		{
			initials: "AC",
			name: "Angel Chen",
			role: "Co-Founder",
			cred: "Former CGO of Ogilvy China. Deep expertise in brand identity, creative systems, and enterprise marketing.",
...
var how$2 = {
	...
	title: "From brand chaos to {highlight}",
	highlight: "consistent output",
	subtitle: "Three steps. No agency required.",
	steps: [
		{
			num: "01",
			title: "Connect your brand",
			desc: "Upload your assets, share reference images, describe your style. Style Genome™ encodes your brand into a 768-dimensional memory vector.",
			detail: "Takes under 10 minutes"
		},
		{
			num: "02",
			title: "Agents get to work",
			desc: "AI agents generate content, qualify leads, resolve tickets, and optimize listings — continuously, on-brand, without prompting.",
			detail: "Runs 24/7 automatically"
		},
		{
			num: "03",
			title: "You stay in control",
			desc: "Review, approve, and publish in one click. Every output scored against your brand memory — so nothing off-brand ships.",
			detail: "Full override at any point"
		}
	]
};
var testimonials$2 = {
	sectionTag: "CLIENT RESULTS",
	title: "Trusted by the brands you know",
	quotes: [
		{
			quote: "We were producing campaign content with five different agencies — inconsistent style, expensive, slow. CanMarket gave us a brand memory layer that every piece of content runs through. Our output looks like us again.",
			role: "Regional Marketing Director",
			company: "Haleon APAC",
			metric: "−80%",
			metricLabel: "reduction in content production cost"
		},
		{
			quote: "The creative calendar feature alone saved our team 20+ hours a week. Campaigns that used to take 3 weeks now go from brief to published in under 48 hours — and the brand DNA stays intact.",
			role: "Head of Digital Marketing",
			company: "Global F&B Group",
			metric: "+150%",
			metricLabel: "lift in social engagement rate"
		},
		{
			quote: "We evaluated seven AI content tools. Most generate visually generic outputs. CanMarket's Style Genome™ actually learned our visual language — the difference in brand recall was measurable within 30 days.",
			role: "Creative Director",
			company: "Publicis Network",
			metric: "30 days",
			metricLabel: "to measurable brand recall improvement"
		}
	]
};
var products$2 = {
	sectionTag: "PRODUCT SUITE",
	title: "One Platform, {highlight}",
	highlight: "Four Agents",
	subtitle: "Each agent is purpose-built for its domain — and all share the same underlying AI platform.",
	notify: "Notify me →",
	cards: [
		{
			name: "CanMarket",
			tag: "AI Marketing Agent",
			description: "Brand-consistent content at scale. Style Genome™ remembers your brand so every image looks like you — not a generic AI output.",
			features: [
				"Brand Memory (Style Genome™)",
		...
		{
			name: "CanService",
			tag: "AI Customer Service Agent",
			description: "24/7 intelligent support across every channel. Resolve tickets faster with AI that understands context and escalates intelligently.",
			features: [
				"Omnichannel AI Chat",
		...
		},
		{
			name: "CanSales",
			tag: "AI Sales Agent",
			description: "From lead to close, automated. AI-powered pipeline management that follows up, qualifies, and converts while you sleep.",
			features: [
				"Smart Lead Scoring",
				"Pipeline Automation",
		...
		},
		{
			...
			description: "Optimize every listing, ad, and conversion funnel. E-commerce intelligence that drives revenue 24 hours a day.",
			features: [
...
var platform$2 = {
	sectionTag: "THE ENGINE",
	title: "Built on a {highlight}",
	highlight: "Unified AI Platform",
	subtitle: "All four agents run on the same infrastructure — share data, share memory, share brand identity.",
	capabilities: [
		{
			icon: "🧠",
			label: "Agent Orchestration",
			desc: "Multi-step reasoning across agents with automated decision routing"
		},
		{
			icon: "🔀",
			label: "Multi-Model Routing",
			desc: "Best model for each task — GPT, Gemini, Claude — intelligently selected"
		},
		{
			icon: "⚡",
			label: "Workflow Automation",
			desc: "Visual workflow builder with trigger-action pipelines and connectors"
		},
		{
			icon: "🗄️",
			label: "Knowledge & Data Layer",
			desc: "768-dim brand memory vectors with retrieval-augmented generation"
		},
		{
			icon: "🔒",
			label: "Enterprise Security",
			desc: "SOC 2 compliant, data isolation, SSO, and audit logs"
		},
		{
			icon: "🌐",
			label: "Multi-Language Support",
			desc: "Native EN / ZH / ZH-TW with locale-aware content generation"
		}
	]
};
var studio$2 = {
	sectionTag: "ENTERPRISE",
	name: "Agent Studio",
	tag: "Custom AI agents for enterprises with unique requirements",
	note: "Powered by the CANLAH platform — no outsourcing",
	headline: "Build any agent your business needs",
	body: "Don't fit a standard product? Agent Studio lets enterprises configure bespoke AI agents on the same platform infrastructure — with full brand memory, model routing, and integration capabilities.",
	cta: "Talk to our team",
	features: [
		{
			icon: "🗂",
			title: "Industry Templates",
			desc: "Pre-built for retail, F&B, finance, healthcare"
		},
		{
			icon: "🔧",
			title: "Visual Workflow Builder",
			desc: "No-code agent configuration with drag & drop"
		},
		{
			icon: "💬",
			title: "Prompt Orchestration",
			desc: "Multi-step chains with memory and context"
		},
		{
			icon: "📚",
			title: "Knowledge Ingestion",
			desc: "Feed docs, URLs, and databases to your agent"
		},
		{
			icon: "🔗",
			title: "API Connectors",
			desc: "Connect to any CRM, ERP, or custom system"
		},
		{
			icon: "🏢",
			title: "Enterprise Deployment",
			desc: "On-prem, private cloud, or managed SaaS"
		}
	]
};
var faq$2 = {
	...
	items: [
		{
			q: "How is CANLAH AI different from ChatGPT or Jasper?",
			a: "ChatGPT and Jasper generate generic content — they don't know your brand. CANLAH AI encodes your brand into a 768-dimensional memory vector (Style Genome™) that every output is checked against. The result is content that looks like your team made it, not an AI. Think of it as the difference between a writing assistant and a brand-trained creative director."
		},
		{
			q: "How does Style Genome™ actually learn my brand?",
			a: "You upload reference images, describe your visual style, and share examples of content you love. Style Genome™ uses a multimodal AI pipeline to extract your color palette, composition patterns, tone, and density — encoding them into a persistent vector. Every future generation is scored against this vector before it reaches you."
		},
		{
			q: "What's the pricing model?",
			a: "CanMarket operates on a credit-based model — you buy credits and spend them on generation tasks. There's a free tier to get started with no credit card required. Enterprise teams can contact us for volume pricing and custom SLAs."
		},
		{
			q: "Is my brand data secure? Where is it stored?",
			a: "All brand memory data is stored with SOC 2-grade infrastructure, encrypted at rest and in transit. Each workspace is fully isolated — your brand vectors and content are never shared with or used to train on behalf of other customers. Enterprise customers can request data residency options."
		},
		{
			q: "How long does onboarding take?",
			a: "Most teams complete their initial brand setup in under 10 minutes — upload a few reference images, answer a short style questionnaire, and your Style Genome™ is ready. Your first AI-generated content is usually produced in the same session."
		},
		{
			q: "Which markets and languages does CanMarket support?",
			a: "CanMarket supports content generation in English, Simplified Chinese, and Traditional Chinese, with more languages on the roadmap. The platform is used by teams across APAC, Europe, and North America. It works with WeChat, Instagram, LinkedIn, Facebook, and other major channels."
		},
		{
			q: "Do I need to replace my existing agency?",
			a: "No — many of our clients (including 4A agencies like Publicis and McCann) use CanMarket alongside their existing workflows. Agencies use it to scale output without proportionally scaling headcount. Brands use it to reduce dependency on agencies for routine content while freeing agency time for strategic work."
		}
	]
};
var cta$2 = {
	badge: "GET STARTED TODAY",
	headline: "Your brand. Every output.\nOn autopilot.",
	sub: "Join the teams at Haleon, Starbucks, and Publicis already running on CANLAH AI. Start with CanMarket — free.",
	primary: "Try CanMarket Free",
	secondary: "Book a Demo",
	note1: "No credit card required",
	note2: "Setup in under 10 minutes",
	note3: "Cancel anytime"
};
var pricing$2 = {
	sectionTag: "PRICING",
	title: "Start free. Scale as you grow.",
	subtitle: "No contracts, no surprises. CanMarket runs on credits — buy what you need, cancel anytime.",
	popularBadge: "MOST POPULAR",
	note: "All plans include SOC 2-grade infrastructure · Data isolation · SSO available on Enterprise",
	tiers: [
		{
			name: "Starter",
			...
			highlight: false,
			cta: "Start for free →",
			ctaUrl: "https://app.canmarket.ai",
			ctaStyle: "border border-white/15 text-white/70 hover:border-white/30 hover:text-white hover:bg-white/5",
			features: [
				"50 AI generations / month",
				"1 brand workspace",
				"Style Genome™ brand memory",
		...
		{
			name: "Growth",
			tag: "FOR GROWING BRANDS & AGENCIES",
			price: "Credits",
			priceSub: "pay as you go",
			highlight: true,
			cta: "Get started →",
			ctaUrl: "https://app.canmarket.ai",
			ctaStyle: "bg-gradient-to-r from-[#0d47e0] to-[#00d4ff] text-white hover:shadow-[0_0_30px_rgba(0,212,255,0.4)] hover:scale-[1.02]",
			features: [
				"Unlimited generations (credit-based)",
				"Up to 5 brand workspaces",
				"Full Style Genome™ + visual memory",
				"Campaign automation",
				"Multi-channel publishing",
				"Priority support",
				"Advanced analytics"
		...
		{
			name: "Enterprise",
			tag: "FOR ENTERPRISE & MULTI-BRAND",
			price: "Custom",
			priceSub: "volume pricing",
			highlight: false,
			cta: "Talk to sales →",
			ctaStyle: "border border-[#6496ff]/30 text-[#6496ff] hover:border-[#6496ff]/60 hover:bg-[#6496ff]/8",
			features: [
				"Unlimited brands & workspaces",
				"All 4 agents (CanMarket + coming soon)",
...
var comparison$2 = {
	sectionTag: "WHY CANLAH",
	title: "Not just another AI tool — ",
	highlight: "built for brands",
	subtitle: "Generic AI generates content. Agencies charge for it. CANLAH AI remembers your brand and scales it.",
	col1: {
		label: "GENERIC AI",
		name: "ChatGPT / Jasper"
	},
	...
	cta: "See CANLAH AI in action",
	ctaNote: "Free tier available — no credit card required"
};
var floatingCta$2 = {
	title: "Ready to try CANLAH AI?",
	sub: "Free tier — no credit card",
	cta: "Start free"
};
var footer$2 = {
	tagline: "AI Agents for Every Business Function",
	status: "All systems operational",
	products: "PRODUCTS",
	company: "COMPANY",
	aboutLink: "About CanMarket",
	contactLink: "Contact Us",
	rights: "© 2026 CANLAH AI. All rights reserved."
};
const locale_en_46json_0ca0f0f4 = {
	nav: nav$2,
	hero: hero$2,
	stats: stats$2,
	team: team$2,
...
var hero$1 = {
	...
	line1: "AI 智能体，赋能",
	line3: "全面增长",
	description: "CANLAH AI 打造专业 AI 智能体，自动化营销、销售、客服和电商——让团队聚焦真正重要的事。",
	cta: "免费试用 CanMarket",
	cta2: "查看产品",
	trustedBy: "顶级品牌信赖之选",
	brand1: "HALEON",
...
var testimonials$1 = {
	...
	quotes: [
		{
			quote: "我们曾与五家不同代理商合作内容生产——风格不一、成本高昂、效率低下。CanMarket 的品牌记忆层让每一件内容输出都通过统一的品牌审核。我们的内容终于又像我们自己了。",
			role: "区域营销总监",
			company: "Haleon 亚太区",
			metric: "−80%",
			metricLabel: "内容生产成本降低"
		},
		{
			quote: "光是创意日历功能每周就为我们节省了20多个小时。原本需要3周的活动，现在从简报到发布不到48小时——品牌基因始终如一。",
			role: "数字营销负责人",
			company: "全球餐饮集团",
			metric: "+150%",
			metricLabel: "社媒互动率提升"
		...
		{
			quote: "我们评估了七款 AI 内容工具。大多数生成的视觉内容千篇一律。CanMarket 的 Style Genome™ 真正学到了我们的视觉语言——30天内品牌识别度的提升是可量化的。",
			role: "创意总监",
			company: "阳狮传播网络",
			metric: "30 天",
			metricLabel: "实现可量化的品牌认知提升"
		}
	]
};
var products$1 = {
	sectionTag: "产品矩阵",
	title: "一个平台，{highlight}",
	highlight: "四大智能体",
	subtitle: "每个智能体专注其行业领域，共享同一底层 AI 平台基础设施。",
	notify: "提前预约 →",
	cards: [
		{
			name: "CanMarket",
			tag: "AI 营销智能体",
			description: "品牌一致性内容大规模生产。Style Genome™ 记住你的品牌，每张图片都像你的团队亲自设计。",
			features: [
				"品牌记忆 (Style Genome™)",
				"AI 内容生成",
				"活动自动化",
		...
		},
		{
			name: "CanService",
			tag: "AI 客服智能体",
			description: "全渠道 7×24 小时智能客服。AI 理解上下文，智能分流工单，更快解决客户问题。",
			features: [
				"全渠道 AI 对话",
				"智能工单路由",
				"知识库 AI",
		...
		},
		{
			name: "CanSales",
			tag: "AI 销售智能体",
			description: "从线索到成交，全程自动化。AI 驱动的销售管道，自动跟进、评分和转化。",
			features: [
				"智能线索评分",
				"销售管道自动化",
				"AI 跟进序列",
		...
		},
		{
			name: "CanCommerce",
			tag: "AI 电商智能体",
			description: "优化每一条商品详情、广告和转化漏斗。全天候电商智能驱动营收增长。",
			features: [
				"商品详情优化",
				"广告投放 AI",
				"转化率分析",
...
var platform$1 = {
	sectionTag: "技术引擎",
	title: "构建于 {highlight}",
	highlight: "统一 AI 平台之上",
	subtitle: "四大智能体运行于同一基础设施——共享数据、共享记忆、共享品牌身份。",
	capabilities: [
		{
			icon: "🧠",
			label: "智能体编排",
			desc: "跨智能体多步推理，自动化决策路由"
		},
		{
			icon: "🔀",
			label: "多模型路由",
			desc: "GPT、Gemini、Claude 按任务智能选择最优模型"
		},
		{
			icon: "⚡",
			label: "工作流自动化",
			desc: "可视化工作流构建器，触发-动作管道和连接器"
		},
		{
			icon: "🗄️",
			label: "知识与数据层",
			desc: "768维品牌记忆向量，检索增强生成"
		},
		{
			icon: "🔒",
			label: "企业级安全",
			desc: "SOC 2 合规，数据隔离，SSO 单点登录，审计日志"
		},
		{
			icon: "🌐",
			label: "多语言支持",
			desc: "原生支持英文/简体中文/繁体中文内容生成"
		}
	]
};
var studio$1 = {
	sectionTag: "企业定制",
	name: "Agent Studio",
	tag: "为有独特需求的企业定制 AI 智能体",
	note: "基于 CANLAH 平台，非外包交付",
	headline: "为你的业务构建任意智能体",
	body: "标准产品不满足需求？Agent Studio 让企业在同一平台基础设施上配置定制 AI 智能体——拥有完整品牌记忆、模型路由和集成能力。",
	cta: "联系我们的团队",
	features: [
		{
			icon: "🗂",
			title: "行业模板",
			desc: "预置零售、餐饮、金融、医疗模板"
		},
		{
			icon: "🔧",
			title: "可视化工作流",
		...
		},
		{
			icon: "🔗",
			title: "API 连接器",
			desc: "对接任意 CRM、ERP 或自定义系统"
		},
		{
			icon: "🏢",
			title: "企业部署",
			desc: "私有化、私有云或托管 SaaS"
		}
	]
};
var team$1 = {
	sectionTag: "创始团队",
	title: "由有实战经验的人打造",
	award: "MWC Pitch2Pitch 2025 · 全球亚军",
	awardSub: "巴塞罗那 · 从全球 3000+ 家创业公司中脱颖而出",
	members: [
		{
			initials: "庞",
			name: "庞浩洋",
			role: "CEO & 创始人",
			cred: "斯坦福 AI 研究背景。Style Genome™ 创造者——驱动所有 CANLAH 产品的品牌记忆层。",
			tag: "AI 架构"
		},
		{
			initials: "朱",
			name: "朱大卫",
			role: "联合创始人",
			cred: "20年4A代理商经验，曾领导跨亚太地区财富500强品牌营销活动。MWC 2025 全球亚军。",
			tag: "品牌战略"
		},
		{
			initials: "陈",
			name: "陈安琪",
			role: "联合创始人",
			cred: "前奥美中国CGO，深耕品牌识别、创意系统与企业级营销。",
			tag: "创意运营"
		}
	]
};
	...
	steps: [
		{
			num: "01",
			title: "接入你的品牌",
			desc: "上传素材、分享参考图、描述风格。Style Genome™ 将你的品牌编码为768维记忆向量。",
			detail: "不到10分钟完成设置"
		},
		{
			num: "02",
			title: "智能体开始工作",
			desc: "AI 智能体持续生成内容、筛选线索、处理工单、优化商品——全天候、品牌一致、无需手动触发。",
			detail: "7×24 小时自动运行"
		},
		{
			num: "03",
			title: "你掌握最终控制权",
			desc: "一键审阅、审批和发布。每个输出都经过品牌记忆评分——确保没有偏离品牌的内容发出去。",
			detail: "随时可以手动覆盖"
		}
	]
};
var faq$1 = {
	...
	items: [
		{
			q: "CANLAH AI 与 ChatGPT 或 Jasper 有什么区别？",
			a: "ChatGPT 和 Jasper 生成的是通用内容——它们不了解你的品牌。CANLAH AI 将你的品牌编码为768维记忆向量（Style Genome™），每一次输出都会与之对照检验。结果是内容看起来像你的团队做的，而不是 AI。把它想象成写作助手和品牌训练创意总监的区别。"
		},
		{
			q: "Style Genome™ 是如何学习我的品牌的？",
			a: "你上传参考图片，描述视觉风格，分享你喜欢的内容示例。Style Genome™ 使用多模态 AI 管道提取你的色彩方案、构图模式、语气和密度——将它们编码为持久向量。每次未来的生成都会在到达你之前与该向量进行评分。"
		},
		{
			q: "定价模式是什么？",
			a: "CanMarket 采用积分制——你购买积分并将其用于生成任务。有免费层级可以开始使用，无需信用卡。企业团队可以联系我们了解批量定价和自定义 SLA。"
		},
		{
			q: "我的品牌数据安全吗？存储在哪里？",
			a: "所有品牌记忆数据都存储在 SOC 2 级别的基础设施中，静态和传输中均已加密。每个工作区完全隔离——你的品牌向量和内容永远不会与其他客户共享或用于训练。企业客户可以请求数据驻留选项。"
		},
		{
			q: "入职需要多长时间？",
			a: "大多数团队在10分钟内完成初始品牌设置——上传几张参考图片，回答简短的风格问卷，你的 Style Genome™ 就准备好了。通常在同一会话中就能生产出第一批 AI 生成内容。"
		},
		{
			q: "CanMarket 支持哪些市场和语言？",
			a: "CanMarket 支持英文、简体中文和繁体中文内容生成，更多语言正在路线图中。平台被亚太、欧洲和北美的团队使用。支持微信、Instagram、LinkedIn、Facebook 等主要渠道。"
		},
		{
			q: "我需要替换现有的代理商吗？",
			a: "不需要——我们的许多客户（包括阳狮和麦肯等4A代理商）将 CanMarket 与现有工作流程结合使用。代理商用它在不按比例增加人员的情况下扩大产出。品牌用它减少对代理商的常规内容依赖，同时将代理商时间释放给战略性工作。"
		}
	]
};
var cta$1 = {
	badge: "立即开始",
	headline: "你的品牌。每一次输出。\n全自动运行。",
	sub: "加入已在使用 CANLAH AI 的 Haleon、星巴克、阳狮团队。从 CanMarket 免费开始。",
	primary: "免费试用 CanMarket",
	secondary: "预约演示",
	note1: "无需信用卡",
	note2: "10分钟内完成设置",
	note3: "随时取消"
...
var pricing$1 = {
	sectionTag: "定价",
	title: "免费开始，随需增长",
	subtitle: "无合同，无惊喜。CanMarket 按积分计费——按需购买，随时取消。",
	popularBadge: "最受欢迎",
	note: "所有方案均含 SOC 2 级基础设施 · 数据隔离 · 企业版支持 SSO",
	tiers: [
		{
			name: "入门版",
			tag: "适合个人及小团队",
...
var comparison$1 = {
	sectionTag: "为何选择 CANLAH",
	title: "不只是另一款 AI 工具——",
	highlight: "专为品牌而生",
	subtitle: "通用 AI 生成内容。代理商收费执行。CANLAH AI 记住你的品牌并规模化输出。",
	col1: {
		label: "通用 AI",
		name: "ChatGPT / Jasper"
	},
	...
	cta: "立即体验 CANLAH AI",
	ctaNote: "提供免费层级，无需信用卡"
};
var floatingCta$1 = {
	title: "准备试用 CANLAH AI？",
	sub: "免费层级，无需信用卡",
	cta: "免费开始"
};
var footer$1 = {
	tagline: "AI 智能体，赋能每一个业务场景",
	status: "所有服务运行正常",
	products: "产品",
	company: "公司",
	aboutLink: "关于 CanMarket",
	contactLink: "联系我们",
	rights: "© 2026 CANLAH AI. 保留所有权利。"
};
const locale_zh_46json_f839a992 = {
	nav: nav$1,
	hero: hero$1,
	stats: stats$1,
...
var hero = {
	...
	line1: "AI 智能體，賦能",
	line3: "全面增長",
	description: "CANLAH AI 打造專業 AI 智能體，自動化行銷、銷售、客服和電商——讓團隊聚焦真正重要的事。",
	cta: "免費試用 CanMarket",
	cta2: "查看產品",
	trustedBy: "頂級品牌信賴之選",
	brand1: "HALEON",
...
var testimonials = {
	...
	quotes: [
		{
			quote: "我們曾與五家不同代理商合作內容生產——風格不一、成本高昂、效率低下。CanMarket 的品牌記憶層讓每一件內容輸出都通過統一的品牌審核。我們的內容終於又像我們自己了。",
			role: "區域行銷總監",
			company: "Haleon 亞太區",
			metric: "−80%",
			metricLabel: "內容生產成本降低"
		},
		{
			quote: "光是創意日曆功能每週就為我們節省了20多個小時。原本需要3週的活動，現在從簡報到發佈不到48小時——品牌基因始終如一。",
			role: "數位行銷負責人",
			company: "全球餐飲集團",
			metric: "+150%",
			metricLabel: "社媒互動率提升"
		...
		{
			quote: "我們評估了七款 AI 內容工具。大多數生成的視覺內容千篇一律。CanMarket 的 Style Genome™ 真正學到了我們的視覺語言——30天內品牌識別度的提升是可量化的。",
			role: "創意總監",
			company: "陽獅傳播網路",
			metric: "30 天",
			metricLabel: "實現可量化的品牌認知提升"
		}
	]
};
var products = {
	sectionTag: "產品矩陣",
	title: "一個平台，{highlight}",
	highlight: "四大智能體",
	subtitle: "每個智能體專注其行業領域，共享同一底層 AI 平台基礎設施。",
	notify: "提前預約 →",
	cards: [
		{
			name: "CanMarket",
			tag: "AI 行銷智能體",
			description: "品牌一致性內容大規模生產。Style Genome™ 記住你的品牌，每張圖片都像你的團隊親自設計。",
			features: [
				"品牌記憶 (Style Genome™)",
				"AI 內容生成",
				"活動自動化",
		...
		},
		{
			name: "CanService",
			tag: "AI 客服智能體",
			description: "全渠道 7×24 小時智能客服。AI 理解上下文，智能分流工單，更快解決客戶問題。",
			features: [
				"全渠道 AI 對話",
				"智能工單路由",
				"知識庫 AI",
		...
		},
		{
			name: "CanSales",
			tag: "AI 銷售智能體",
			description: "從線索到成交，全程自動化。AI 驅動的銷售管道，自動跟進、評分和轉化。",
			features: [
				"智能線索評分",
				"銷售管道自動化",
				"AI 跟進序列",
		...
		},
		{
			name: "CanCommerce",
			tag: "AI 電商智能體",
			description: "優化每一條商品詳情、廣告和轉化漏斗。全天候電商智能驅動營收增長。",
			features: [
				"商品詳情優化",
				"廣告投放 AI",
				"轉化率分析",
...
var platform = {
	sectionTag: "技術引擎",
	title: "構建於 {highlight}",
	highlight: "統一 AI 平台之上",
	subtitle: "四大智能體運行於同一基礎設施——共享數據、共享記憶、共享品牌身份。",
	capabilities: [
		{
			icon: "🧠",
			label: "智能體編排",
			desc: "跨智能體多步推理，自動化決策路由"
		},
		{
			icon: "🔀",
			label: "多模型路由",
			desc: "GPT、Gemini、Claude 按任務智能選擇最優模型"
		},
		{
			icon: "⚡",
			label: "工作流自動化",
			desc: "可視化工作流構建器，觸發-動作管道和連接器"
		},
		{
			icon: "🗄️",
			label: "知識與數據層",
			desc: "768維品牌記憶向量，檢索增強生成"
		},
		{
			icon: "🔒",
			label: "企業級安全",
			desc: "SOC 2 合規，數據隔離，SSO 單點登錄，審計日誌"
		},
		{
			icon: "🌐",
			label: "多語言支持",
			desc: "原生支持英文/簡體中文/繁體中文內容生成"
		}
	]
};
var studio = {
	sectionTag: "企業定制",
	name: "Agent Studio",
	tag: "為有獨特需求的企業定制 AI 智能體",
	note: "基於 CANLAH 平台，非外包交付",
	headline: "為你的業務構建任意智能體",
	body: "標準產品不滿足需求？Agent Studio 讓企業在同一平台基礎設施上配置定制 AI 智能體——擁有完整品牌記憶、模型路由和集成能力。",
	cta: "聯繫我們的團隊",
	features: [
		{
			icon: "🗂",
			title: "行業模板",
			desc: "預置零售、餐飲、金融、醫療模板"
		},
		{
			icon: "🔧",
			title: "可視化工作流",
		...
		},
		{
			icon: "🔗",
			title: "API 連接器",
			desc: "對接任意 CRM、ERP 或自定義系統"
		},
		{
			icon: "🏢",
			title: "企業部署",
			desc: "私有化、私有雲或託管 SaaS"
		}
	]
};
var team = {
	sectionTag: "創始團隊",
	title: "由有實戰經驗的人打造",
	award: "MWC Pitch2Pitch 2025 · 全球亞軍",
	awardSub: "巴塞隆納 · 從全球 3000+ 家新創公司中脫穎而出",
	members: [
		{
			initials: "龐",
			name: "龐浩洋",
			role: "CEO & 創始人",
			cred: "史丹佛 AI 研究背景。Style Genome™ 創造者——驅動所有 CANLAH 產品的品牌記憶層。",
			tag: "AI 架構"
		},
		{
			initials: "朱",
			name: "朱大衛",
			role: "聯合創始人",
			cred: "20年4A代理商經驗，曾領導跨亞太地區財富500強品牌行銷活動。MWC 2025 全球亞軍。",
			tag: "品牌策略"
		},
		{
			initials: "陳",
			name: "陳安琪",
			role: "聯合創始人",
			cred: "前奧美中國CGO，深耕品牌識別、創意系統與企業級行銷。",
			tag: "創意營運"
		}
	]
};
	...
	steps: [
		{
			num: "01",
			title: "接入你的品牌",
			desc: "上傳素材、分享參考圖、描述風格。Style Genome™ 將你的品牌編碼為768維記憶向量。",
			detail: "不到10分鐘完成設置"
		},
		{
			num: "02",
			title: "智能體開始工作",
			desc: "AI 智能體持續生成內容、篩選線索、處理工單、優化商品——全天候、品牌一致、無需手動觸發。",
			detail: "7×24 小時自動運行"
		},
		{
			num: "03",
			title: "你掌握最終控制權",
			desc: "一鍵審閱、審批和發佈。每個輸出都經過品牌記憶評分——確保沒有偏離品牌的內容發出去。",
			detail: "隨時可以手動覆蓋"
		}
	]
};
var faq = {
	...
	items: [
		{
			q: "CANLAH AI 與 ChatGPT 或 Jasper 有什麼區別？",
			a: "ChatGPT 和 Jasper 生成的是通用內容——它們不了解你的品牌。CANLAH AI 將你的品牌編碼為768維記憶向量（Style Genome™），每一次輸出都會與之對照檢驗。結果是內容看起來像你的團隊做的，而不是 AI。把它想像成寫作助手和品牌訓練創意總監的區別。"
		},
		{
			q: "Style Genome™ 是如何學習我的品牌的？",
			a: "你上傳參考圖片，描述視覺風格，分享你喜歡的內容示例。Style Genome™ 使用多模態 AI 管道提取你的色彩方案、構圖模式、語氣和密度——將它們編碼為持久向量。每次未來的生成都會在到達你之前與該向量進行評分。"
		},
		{
			q: "定價模式是什麼？",
			a: "CanMarket 採用積分制——你購買積分並將其用於生成任務。有免費層級可以開始使用，無需信用卡。企業團隊可以聯繫我們了解批量定價和自定義 SLA。"
		},
		{
			q: "我的品牌數據安全嗎？存儲在哪裡？",
			a: "所有品牌記憶數據都存儲在 SOC 2 級別的基礎設施中，靜態和傳輸中均已加密。每個工作區完全隔離——你的品牌向量和內容永遠不會與其他客戶共享或用於訓練。企業客戶可以請求數據駐留選項。"
		},
		{
			q: "入職需要多長時間？",
			a: "大多數團隊在10分鐘內完成初始品牌設置——上傳幾張參考圖片，回答簡短的風格問卷，你的 Style Genome™ 就準備好了。通常在同一會話中就能生產出第一批 AI 生成內容。"
		},
		{
			q: "CanMarket 支持哪些市場和語言？",
			a: "CanMarket 支持英文、簡體中文和繁體中文內容生成，更多語言正在路線圖中。平台被亞太、歐洲和北美的團隊使用。支持微信、Instagram、LinkedIn、Facebook 等主要渠道。"
		},
		{
			q: "我需要替換現有的代理商嗎？",
			a: "不需要——我們的許多客戶（包括陽獅和麥肯等4A代理商）將 CanMarket 與現有工作流程結合使用。代理商用它在不按比例增加人員的情況下擴大產出。品牌用它減少對代理商的常規內容依賴，同時將代理商時間釋放給戰略性工作。"
		}
	]
};
var cta = {
	badge: "立即開始",
	headline: "你的品牌。每一次輸出。\n全自動運行。",
	sub: "加入已在使用 CANLAH AI 的 Haleon、星巴克、陽獅團隊。從 CanMarket 免費開始。",
	primary: "免費試用 CanMarket",
	secondary: "預約演示",
	note1: "無需信用卡",
	note2: "10分鐘內完成設置",
	note3: "隨時取消"
...
var pricing = {
	sectionTag: "定價",
	title: "免費開始，隨需增長",
	subtitle: "無合約，無驚喜。CanMarket 按積分計費——按需購買，隨時取消。",
	popularBadge: "最受歡迎",
	note: "所有方案均含 SOC 2 級基礎設施 · 數據隔離 · 企業版支持 SSO",
	tiers: [
		{
			name: "入門版",
			tag: "適合個人及小團隊",
...
var comparison = {
	sectionTag: "為何選擇 CANLAH",
	title: "不只是另一款 AI 工具——",
	highlight: "專為品牌而生",
	subtitle: "通用 AI 生成內容。代理商收費執行。CANLAH AI 記住你的品牌並規模化輸出。",
	col1: {
		label: "通用 AI",
		name: "ChatGPT / Jasper"
	},
	...
	cta: "立即體驗 CANLAH AI",
	ctaNote: "提供免費層級，無需信用卡"
};
var floatingCta = {
	title: "準備試用 CANLAH AI？",
	sub: "免費層級，無需信用卡",
	cta: "免費開始"
};
var footer = {
	tagline: "AI 智能體，賦能每一個業務場景",
	status: "所有服務運行正常",
	products: "產品",
	company: "公司",
	aboutLink: "關於 CanMarket",
	contactLink: "聯繫我們",
	rights: "© 2026 CANLAH AI. 保留所有權利。"
};
const locale_zh_45tw_46json_9c33f892 = {
	nav: nav,
	hero: hero,
	stats: stats,
...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_0ca0f0f4",
      load: () => Promise.resolve(locale_en_46json_0ca0f0f4),
      cache: true
    }
  ],
  zh: [
    {
      key: "locale_zh_46json_f839a992",
      load: () => Promise.resolve(locale_zh_46json_f839a992),
      cache: true
    }
  ],
  "zh-tw": [
    {
      key: "locale_zh_45tw_46json_9c33f892",
      load: () => Promise.resolve(locale_zh_45tw_46json_9c33f892),
      cache: true
    }
  ]
};
...
const appHead = {"link":[{"rel":"icon","href":"/favicon.svg","type":"image/svg+xml","sizes":"any"}],"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{}};
...
const _mH2weKzG0bKg9A76G7ntUcDv9wy0PCP13tg3WQ4FhY = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async (context) => {
    ...
    if (!url.pathname.includes("/_i18n/uo_-vXpS") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _Jd2c0TrI6BMIG5Thx_w6dDBPcaFK4gzhvQsIW1TpWg,
_WH60A5T9dDuzZ4MmVOPKVoTrvuJDLIzMDQinoQKwKZE,
_GGAffswNZBno80JrEIle4mYWGxo2x5QwjYkH9_toRhg,
_mH2weKzG0bKg9A76G7ntUcDv9wy0PCP13tg3WQ4FhY
];

const assets = {
  "/favicon.svg": {
    "type": "image/svg+xml",
    "etag": "\"1f8-eUgfyu0Kbr8bGbq4ORFx53yLodQ\"",
    "mtime": "2026-03-19T18:06:02.197Z",
    "size": 504,
    "path": "../public/favicon.svg"
  },
  "/_nuxt/B3hg7RLn.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1bad-FBlEvKio5iDXkE8X+POB+XJ9nTE\"",
    "mtime": "2026-03-19T18:06:02.194Z",
    "size": 7085,
    "path": "../public/_nuxt/B3hg7RLn.js"
  },
  "/_nuxt/B_-t01nd.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"50f7-hDX9Jt+ilkhBrf9FWuikv0NT34Y\"",
    "mtime": "2026-03-19T18:06:02.194Z",
    "size": 20727,
    "path": "../public/_nuxt/B_-t01nd.js"
  },
  "/_nuxt/J5fsHJiI.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"7885-iBDJdoJH3SQlVP1pUb4W/37TzDM\"",
    "mtime": "2026-03-19T18:06:02.195Z",
    "size": 30853,
    "path": "../public/_nuxt/J5fsHJiI.js"
  },
  "/_nuxt/DIBdq62d.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"53b0-31RZhlG89BpO5J6k/aAhLCcb6LM\"",
    "mtime": "2026-03-19T18:06:02.194Z",
    "size": 21424,
    "path": "../public/_nuxt/DIBdq62d.js"
  },
  "/_nuxt/BhKRF13c.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"50f7-VAR6MF6cNHsBeLgh4g+VbJ0kmYM\"",
    "mtime": "2026-03-19T18:06:02.194Z",
    "size": 20727,
    "path": "../public/_nuxt/BhKRF13c.js"
  },
  "/_nuxt/entry.Ebyy6Yjg.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"c6a8-Z9cOwilETczyfRJM8dvTc6FWaXk\"",
    "mtime": "2026-03-19T18:06:02.195Z",
    "size": 50856,
    "path": "../public/_nuxt/entry.Ebyy6Yjg.css"
  },
  "/_nuxt/lsocy5hT.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3145-SLBBoYaJlEz2UQ5PEntlhFpL7Zc\"",
    "mtime": "2026-03-19T18:06:02.194Z",
    "size": 12613,
    "path": "../public/_nuxt/lsocy5hT.js"
  },
  "/_nuxt/BBVkUvXw.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"42842-7+Q3RC7wQeIhX68z6ZHn3Vs3G6U\"",
    "mtime": "2026-03-19T18:06:02.195Z",
    "size": 272450,
    "path": "../public/_nuxt/BBVkUvXw.js"
  },
  "/_nuxt/builds/meta/d4d8a00d-69c2-4330-9c87-1acb4a4c8253.json": {
    "type": "application/json",
    "etag": "\"58-4UyCCHgRRQvamEdyQ6WYLv0xX7g\"",
    "mtime": "2026-03-19T18:06:02.186Z",
    "size": 88,
    "path": "../public/_nuxt/builds/meta/d4d8a00d-69c2-4330-9c87-1acb4a4c8253.json"
  },
  "/_nuxt/builds/latest.json": {
    "type": "application/json",
    "etag": "\"47-RRtnLg0Y+PhT6jvMl0jUt+rB72I\"",
    "mtime": "2026-03-19T18:06:02.190Z",
    "size": 71,
...
const _Hk6OcL = eventHandler((event) => {
...
const _Wtl3V8 = eventHandler(async (e) => {
...
const _Tgepxd = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _4S_udU = defineEventHandler(async (e) => {
...
const _zn7Zlu = defineEventHandler(async (e) => {
...
const _eVuL5m = defineEventHandler(sitemapXmlEventHandler);

const _ZkEuSM = defineEventHandler((e) => {
  const path = e.path;
...
const _aQfcZi = _messagesHandlerCached;

const _lazy_U1V1Xs = () => import('../routes/renderer.mjs');
const _lazy_z0qZ98 = () => import('../routes/sitemap_index.xml.mjs');
const _lazy_KfEyB4 = () => import('../routes/__sitemap__/_sitemap_.xml.mjs');
const _lazy_YtaPiu = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_bKaYvn = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '', handler: _Hk6OcL, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_U1V1Xs, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Wtl3V8, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _Tgepxd, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _4S_udU, lazy: false, middleware: true, method: undefined },
  { route: '/sitemap_index.xml', handler: _lazy_z0qZ98, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/**:sitemap', handler: _lazy_KfEyB4, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _zn7Zlu, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _eVuL5m, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_YtaPiu, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_bKaYvn, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_bKaYvn, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _ZkEuSM, lazy: false, middleware: true, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _aQfcZi, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_U1V1Xs, lazy: true, middleware: false, method: undefined }
];
...
export { sanitizeStatusCode as $, useNitroOrigin as A, emojiCache as B, useOgImageRuntimeConfig as C, fetchIsland as D, createHeadCore as E, normaliseFontInput as F, theme as G, withTrailingSlash as H, handleCacheHeaders as I, setHeaders as J, setHeader as K, hash$1 as L, parseURL as M, NUXT_RUNTIME_PAYLOAD_EXTRACTION as N, setResponseHeader as O, proxyRequest as P, sendRedirect as Q, resolveContext as R, H3Error as S, encodePath as T, decodePath as U, headSymbol as V, defu as W, hasProtocol as X, isScriptProtocol as Y, withQuery as Z, useHead as _, getResponseStatus as a, getContext as a0, $fetch$1 as a1, baseURL as a2, executeAsync as a3, withoutTrailingSlash as a4, titleCase as a5, withHttps as a6, stringifyQuery as a7, camelCase as a8, withLeadingSlash as a9, withBase as aa, toRouteMatcher as ab, createRouter$1 as ac, withoutBase as ad, getRequestURL as ae, useSeoMeta as af, getRequestHeader as ag, getCookie as ah, klona as ai, parsePath as aj, parseQuery as ak, isEqual as al, createDefu as am, setCookie as an, deleteCookie as ao, resolveUnrefHeadInput as ap, isEqual$1 as aq, decodeHtml as ar, logger$1 as as, toBase64Image as at, htmlDecodeQuotes as au, sendError as av, fontCache as aw, nodeServer as ax, appId as b, buildAssetsURL as c, defineRenderHandler as d, appTeleportTag as e, appTeleportAttrs as f, getResponseStatusText as g, getQuery as h, createError$1 as i, createSSRContext as j, appHead as k, destr as l, getRouteRules as m, joinURL as n, getRenderer as o, publicAssetsURL as p, replaceIslandTeleports as q, renderInlineStyles as r, setSSRError as s, NUXT_PAYLOAD_INLINE as t, useNitroApp as u, defineEventHandler as v, sitemapIndexXmlEventHandler as w, sitemapChildXmlEventHandler as x, prefixStorage as y, useStorage as z };
